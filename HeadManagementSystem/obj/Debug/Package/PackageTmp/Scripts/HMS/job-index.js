...
HMS.Job = function () {
    ...
    this.Delete = function (Id) {
        swal({
            ...
            text: "Chú ý tất cả dữ liệu liên quan đến nghề nghiệp này cũng sẽ bị mất theo.",
            type: "warning",
    ...
    this.Edit = function (Id) {
        $('#btSave').show();
        $('#btAdd').hide();
        Global.Data.selectedObj = $.map(Global.Data.JobXe, function (item, i) {
            if (item.Id == Id)
                return item;
        })[0];
        ...
        $.ajax({
            ...
            success: function (objs) {
                ...
                if (Global.Data.table != null) {
                    ...
                    Global.Data.JobXe.length = 0;
                }
                Global.Data.JobXe = objs;
                InitTable(objs);
            }
        });
    }
    ...
    function InitTable(Objs) {
        Global.Data.table = $('#job-table').DataTable({
            responsive: true, 
            "data": Objs,
        ...
        $('#job-table_wrapper #job-table_filter').append($('<label><i class="fa fa-file-excel-o fa-lg col-red pointer" title="xuất excel" aria-hidden="true"></i></label>'));
    }
